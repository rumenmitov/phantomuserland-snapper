...
typedef FT_ULong (*FTC_Node_WeightFunc)(FTC_Node node, FTC_Cache cache);
 ...
 */
FT_EXPORT(FT_Error)
FTC_Cache_Lookup(FTC_Cache cache, FT_UInt32 hash, FT_Pointer query, FTC_Node *anode);
...
#define FTC_CACHE_LOOKUP_CMP(cache, nodecmp, hash, query, node, error)                \
	...
	{                                                                                 \
		...
		if (_node != _manager->nodes_list)                                            \
			FTC_MruNode_Up((FTC_MruNode *)&_manager->nodes_list, (FTC_MruNode)_node); \
	}                                                                                 \
	goto _Ok;                                                                         \
                                                                                      \
	_NewNode:                                                                         \
