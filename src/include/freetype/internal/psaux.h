...
#define T1_NEW_SIMPLE_FIELD(_ident, _type, _fname) \
	{_ident, T1CODE, _type, 0, FT_FIELD_OFFSET(_fname), FT_FIELD_SIZE(_fname), 0, 0},

#define T1_NEW_CALLBACK_FIELD(_ident, _reader) \
	{_ident, T1CODE, T1_FIELD_TYPE_CALLBACK, (T1_Field_ParseFunc)_reader, 0, 0, 0, 0},
...
#define T1_FIELD_CALLBACK(_ident, _name) T1_NEW_CALLBACK_FIELD(_ident, _name)
...
typedef struct PS_Parser_FuncsRec_
{
	...
	FT_Error (*to_bytes)(PS_Parser parser,
						 FT_Byte *bytes,
						 FT_Long max_bytes,
						 FT_Long *pnum_bytes,
						 FT_Bool delimiters);
	...
	FT_Int (*to_fixed_array)(PS_Parser parser,
							 FT_Int max_values,
							 FT_Fixed *values,
							 FT_Int power_ten);
	...
	FT_Error (*load_field)(PS_Parser parser,
						   const T1_Field field,
						   void **objects,
						   FT_UInt max_objects,
						   FT_ULong *pflags);

	FT_Error (*load_field_table)(PS_Parser parser,
								 const T1_Field field,
								 void **objects,
								 FT_UInt max_objects,
								 FT_ULong *pflags);
