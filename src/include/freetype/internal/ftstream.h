...
#define FT_FIELD_OFFSET(f) (FT_UShort)(__offsetof(FT_STRUCTURE, f))
...
#define FT_PEEK_SHORT(p) FT_INT16(FT_INT8_I16(p, 0, 8) | FT_BYTE_I16(p, 1, 0))

#define FT_PEEK_USHORT(p) FT_UINT16(FT_BYTE_U16(p, 0, 8) | FT_BYTE_U16(p, 1, 0))

#define FT_PEEK_LONG(p)                                                             \
	FT_INT32(FT_INT8_I32(p, 0, 24) | FT_BYTE_I32(p, 1, 16) | FT_BYTE_I32(p, 2, 8) | \
			 FT_BYTE_I32(p, 3, 0))

#define FT_PEEK_ULONG(p)                                                             \
	FT_UINT32(FT_BYTE_U32(p, 0, 24) | FT_BYTE_U32(p, 1, 16) | FT_BYTE_U32(p, 2, 8) | \
			  FT_BYTE_U32(p, 3, 0))
...
#define FT_PEEK_SHORT_LE(p) FT_INT16(FT_INT8_I16(p, 1, 8) | FT_BYTE_I16(p, 0, 0))

#define FT_PEEK_USHORT_LE(p) FT_UINT16(FT_BYTE_U16(p, 1, 8) | FT_BYTE_U16(p, 0, 0))

#define FT_PEEK_LONG_LE(p)                                                          \
	FT_INT32(FT_INT8_I32(p, 3, 24) | FT_BYTE_I32(p, 2, 16) | FT_BYTE_I32(p, 1, 8) | \
			 FT_BYTE_I32(p, 0, 0))

#define FT_PEEK_ULONG_LE(p)                                                          \
	FT_UINT32(FT_BYTE_U32(p, 3, 24) | FT_BYTE_U32(p, 2, 16) | FT_BYTE_U32(p, 1, 8) | \
			  FT_BYTE_U32(p, 0, 0))
...
#define FT_FRAME_ENTER(size) FT_SET_ERROR(FT_Stream_EnterFrame(stream, size))

#define FT_FRAME_EXIT() FT_Stream_ExitFrame(stream)

#define FT_FRAME_EXTRACT(size, bytes) \
	FT_SET_ERROR(FT_Stream_ExtractFrame(stream, size, (FT_Byte **)&(bytes)))
