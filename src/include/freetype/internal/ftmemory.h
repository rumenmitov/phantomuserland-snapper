...
/*                                                                       */
FT_BASE(FT_Error)
FT_QAlloc(FT_Memory memory, FT_Long size, void **p);
...
/*                                                                       */
FT_BASE(FT_Error)
FT_QRealloc(FT_Memory memory, FT_Long current, FT_Long size, void **p);
...
#define FT_MEM_ALLOC(_pointer_, _size_) \
	FT_Alloc_Debug(memory, _size_, (void **)(void *)&(_pointer_), __FILE__, __LINE__)

#define FT_MEM_REALLOC(_pointer_, _current_, _size_) \
	FT_Realloc_Debug(                                \
		memory, _current_, _size_, (void **)(void *)&(_pointer_), __FILE__, __LINE__)

#define FT_MEM_QALLOC(_pointer_, _size_) \
	FT_QAlloc_Debug(memory, _size_, (void **)(void *)&(_pointer_), __FILE__, __LINE__)
...
#define FT_MEM_FREE(_pointer_) FT_Free(memory, (void **)(void *)&(_pointer_))
...
#define FT_MEM_RENEW_ARRAY(_pointer_, _old_, _new_) \
	FT_MEM_REALLOC(_pointer_,                       \
				   (_old_) * sizeof(*(_pointer_)),  \
				   (_new_) * sizeof(*(_pointer_)))

#define FT_MEM_QNEW(_pointer_) FT_MEM_QALLOC(_pointer_, sizeof(*(_pointer_)))
...
#define FT_MEM_REALLOC_ARRAY(_pointer_, _old_, _new_, _type_) \
	FT_MEM_REALLOC(_pointer_, (_old_) * sizeof(_type), (_new_) * sizeof(_type_))
...
#define FT_QALLOC(_pointer_, _size_) FT_SET_ERROR(FT_MEM_QALLOC(_pointer_, _size_))
...
#define FT_NEW(_pointer_) FT_ALLOC(_pointer_, sizeof(*(_pointer_)))
...
#define FT_RENEW_ARRAY(_pointer_, _old_, _new_) \
	FT_REALLOC(_pointer_, sizeof(*(_pointer_)) * (_old_), sizeof(*(_pointer_)) * (_new_))

#define FT_QNEW(_pointer_) FT_QALLOC(_pointer_, sizeof(*(_pointer_)))
...
#define FT_QRENEW_ARRAY(_pointer_, _old_, _new_) \
	FT_QREALLOC(_pointer_, sizeof(*(_pointer_)) * (_old_), sizeof(*(_pointer_)) * (_new_))
...
#define FT_REALLOC_ARRAY(_pointer_, _old_, _new_, _type_) \
	FT_REALLOC(_pointer, (_old_) * sizeof(_type_), (_new_) * sizeof(_type_))
