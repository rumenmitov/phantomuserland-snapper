...
/*                                                                       */
typedef FT_Error (*TT_Init_Face_Func)(FT_Stream stream,
									  TT_Face face,
									  FT_Int face_index,
									  FT_Int num_params,
									  FT_Parameter *params);
...
/*                                                                       */
typedef FT_Error (*TT_Load_Face_Func)(FT_Stream stream,
									  TT_Face face,
									  FT_Int face_index,
									  FT_Int num_params,
									  FT_Parameter *params);
...
/*                                                                       */
typedef FT_Error (*TT_Load_SFNT_HeaderRec_Func)(TT_Face face,
												FT_Stream stream,
												FT_Long face_index,
												SFNT_Header sfnt);
...
/*    TT_Load_Format_Tag().                                              */
/*                                                                       */
typedef FT_Error (*TT_Load_Directory_Func)(TT_Face face,
										   FT_Stream stream,
										   SFNT_Header sfnt);
...
/*                                                                       */
typedef FT_Error (*TT_Load_Any_Func)(
...
/*    glyph.                                                             */
/*                                                                       */
typedef FT_Error (*TT_Find_SBit_Image_Func)(TT_Face face,
											FT_UInt glyph_index,
...
/*                                                                       */
typedef FT_Error (*TT_Load_SBit_Image_Func)(TT_Face face,
											FT_ULong strike_index,
											FT_UInt glyph_index,
											FT_UInt load_flags,
											FT_Stream stream,
...
/*                                                                       */
typedef FT_Error (*TT_Set_SBit_Strike_Func)(TT_Face face,
											FT_UInt x_ppem,
											FT_UInt y_ppem,
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
typedef FT_Error (*TT_Load_Metrics_Func)(TT_Face face,
										 FT_Stream stream,
										 FT_Bool vertical);
