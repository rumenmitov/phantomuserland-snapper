 ...
 */
typedef FT_Pointer (*FT_Memory_AllocFunc)(FT_ULong size, FT_Pointer mem_data);
 ...
 *               (see @ft_memory_new)
 */
typedef void (*FT_Memory_FreeFunc)(FT_Pointer block, FT_Pointer mem_data);
 ...
 */
typedef void (*FT_Memory_DestroyFunc)(FT_Memory memory, FT_Pointer mem_data);
 ...
 */
FT_BASE(FT_Memory)
ft_memory_new(FT_Memory_Funcs mem_funcs, FT_Pointer mem_init_data);
