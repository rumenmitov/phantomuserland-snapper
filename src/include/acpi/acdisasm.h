...
typedef ACPI_STATUS (*ASL_WALK_CALLBACK)(ACPI_PARSE_OBJECT *Op,
										 UINT32 Level,
										 void *Context);
...
ACPI_STATUS
AcpiDmDumpTable(UINT32 TableLength,
				UINT32 TableOffset,
				void *Table,
 ...
 * dmwalk
 */
void AcpiDmDisassemble(ACPI_WALK_STATE *WalkState,
 ...
 * dmopcode
 */
void AcpiDmDisassembleOneOp(ACPI_WALK_STATE *WalkState,
...
void AcpiDmDumpMethodInfo(ACPI_STATUS Status,
						  ACPI_WALK_STATE *WalkState,
						  ACPI_PARSE_OBJECT *Op);
...
void AcpiDmResourceTemplate(ACPI_OP_WALK_INFO *Info,
							ACPI_PARSE_OBJECT *Op,
							UINT8 *ByteData,
							UINT32 ByteCount);

ACPI_STATUS
AcpiDmIsResourceTemplate(ACPI_PARSE_OBJECT *Op);
