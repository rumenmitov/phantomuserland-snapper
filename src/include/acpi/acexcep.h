...
char const *AcpiGbl_ExceptionNames_Pgm[] = {NULL,
											"AE_BAD_PARAMETER",
											"AE_BAD_CHARACTER",
											"AE_BAD_PATHNAME",
											"AE_BAD_DATA",
...
char const *AcpiGbl_ExceptionNames_Tbl[] = {NULL,
											"AE_BAD_SIGNATURE",
											"AE_BAD_HEADER",
											"AE_BAD_CHECKSUM",
											"AE_BAD_VALUE",
...
char const *AcpiGbl_ExceptionNames_Aml[] = {NULL,
											"AE_AML_BAD_OPCODE",
											"AE_AML_NO_OPERAND",
											"AE_AML_OPERAND_TYPE",
...
char const *AcpiGbl_ExceptionNames_Ctrl[] = {NULL,
