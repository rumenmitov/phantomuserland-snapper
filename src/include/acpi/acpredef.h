...
static const ACPI_PREDEFINED_INFO PredefinedNames[] = {
	...
	{{"_PRW",
	  0,
	  ACPI_RTYPE_PACKAGE}}, /* Variable-length (Pkgs) each: Pkg/Int,Int,[Variable-length
							   Refs] (Pkg is Ref/Int) */
	{{{ACPI_PTYPE1_OPTION,
	   2,
	...
	{{"_SCP",
	  0x13,
	  0}}, /* Acpi 1.0 allowed 1 arg. Acpi 3.0 expanded to 3 args. Allow both. */
	...
	/* Acpi 1.0 defined _WAK with no return value. Later, it was changed to return a
	   package */

	{{"_WAK", 1, ACPI_RTYPE_NONE | ACPI_RTYPE_INTEGER | ACPI_RTYPE_PACKAGE}},
	{{{ACPI_PTYPE1_FIXED, ACPI_RTYPE_INTEGER, 2, 0},
	  0,
