...
ACPI_STATUS
AcpiPsGetNextNamepath(ACPI_WALK_STATE *WalkState,
					  ACPI_PARSE_STATE *ParserState,
					  ACPI_PARSE_OBJECT *Arg,
					  BOOLEAN MethodCall);

ACPI_STATUS
AcpiPsGetNextArg(ACPI_WALK_STATE *WalkState,
				 ACPI_PARSE_STATE *ParserState,
				 UINT32 ArgType,
...
char *AcpiPsGetOpcodeName(UINT16 Opcode);
...
ACPI_STATUS
AcpiPsNextParseState(ACPI_WALK_STATE *WalkState,
...
ACPI_STATUS
AcpiPsPushScope(ACPI_PARSE_STATE *ParserState,
				ACPI_PARSE_OBJECT *Op,
 ...
 */
ACPI_STATUS
AcpiPsWalkParsedAml(ACPI_PARSE_OBJECT *StartOp,
...
ACPI_STATUS
AcpiPsGetNextWalkOp(ACPI_WALK_STATE *WalkState,
					ACPI_PARSE_OBJECT *Op,
					ACPI_PARSE_UPWARDS AscendingCallback);
 ...
 */
ACPI_PARSE_OBJECT *AcpiPsCreateScopeOp(void);
