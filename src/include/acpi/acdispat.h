 ...
 */
ACPI_STATUS
AcpiDsCreateField(ACPI_PARSE_OBJECT *Op,
 ...
 */
ACPI_STATUS
AcpiDsStoreObjectToLocal(UINT8 Type,
						 UINT32 Index,
						 ACPI_OPERAND_OBJECT *SrcDesc,
						 ACPI_WALK_STATE *WalkState);

ACPI_STATUS
AcpiDsMethodDataGetEntry(UINT16 Opcode,
						 UINT32 Index,
						 ACPI_WALK_STATE *WalkState,
...
ACPI_STATUS
AcpiDsMethodDataGetValue(UINT8 Type,
						 UINT32 Index,
						 ACPI_WALK_STATE *WalkState,
...
ACPI_STATUS
AcpiDsMethodDataGetNode(UINT8 Type,
						UINT32 Index,
						ACPI_WALK_STATE *WalkState,
 ...
 */
ACPI_STATUS
AcpiDsParseMethod(ACPI_NAMESPACE_NODE *Node);
...
ACPI_STATUS
AcpiDsInitObjectFromOp(ACPI_WALK_STATE *WalkState,
					   ACPI_PARSE_OBJECT *Op,
					   UINT16 Opcode,
					   ACPI_OPERAND_OBJECT **ObjDesc);

ACPI_STATUS
AcpiDsCreateNode(ACPI_WALK_STATE *WalkState,
				 ACPI_NAMESPACE_NODE *Node,
				 ACPI_PARSE_OBJECT *Op);
...
ACPI_STATUS
AcpiDsCreateOperand(ACPI_WALK_STATE *WalkState,
 ...
 */
ACPI_STATUS
AcpiDsScopeStackPush(ACPI_NAMESPACE_NODE *Node,
...
ACPI_STATUS
AcpiDsInitAmlWalk(ACPI_WALK_STATE *WalkState,
				  ACPI_PARSE_OBJECT *Op,
