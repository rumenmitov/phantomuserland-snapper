...
ACPI_STATUS
AcpiRsCreateAmlResources(ACPI_RESOURCE *LinkedListBuffer, ACPI_BUFFER *OutputBuffer);
...
ACPI_STATUS
AcpiRsGetMethodData(ACPI_HANDLE Handle, char *Path, ACPI_BUFFER *RetBuffer);
...
ACPI_STATUS
AcpiRsGetAmlLength(ACPI_RESOURCE *LinkedListBuffer, ACPI_SIZE *SizeNeeded);
...
ACPI_STATUS
AcpiRsConvertResourcesToAml(ACPI_RESOURCE *Resource,
 ...
 */
ACPI_STATUS
AcpiRsConvertAmlToResource(ACPI_RESOURCE *Resource,
						   AML_RESOURCE *Aml,
						   ACPI_RSCONVERT_INFO *Info);

ACPI_STATUS
AcpiRsConvertResourceToAml(ACPI_RESOURCE *Resource,
						   AML_RESOURCE *Aml,
						   ACPI_RSCONVERT_INFO *Info);
...
ACPI_RS_LENGTH
AcpiRsGetResourceSource(ACPI_RS_LENGTH ResourceLength,
...
ACPI_RSDESC_SIZE
AcpiRsSetResourceSource(AML_RESOURCE *Aml,
						ACPI_RS_LENGTH MinimumLength,
						ACPI_RESOURCE_SOURCE *ResourceSource);
