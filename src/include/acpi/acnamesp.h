 ...
 */
ACPI_STATUS
AcpiNsWalkNamespace(ACPI_OBJECT_TYPE Type,
...
ACPI_STATUS
AcpiNsOneCompleteParse(UINT32 PassNumber,
					   UINT32 TableIndex,
...
ACPI_STATUS
AcpiNsLookup(ACPI_GENERIC_STATE *ScopeInfo,
			 char *Name,
...
ACPI_STATUS
AcpiNsDumpOneObject(ACPI_HANDLE ObjHandle,
					UINT32 Level,
					void *Context,
					void **ReturnValue);
 ...
 */
ACPI_STATUS
AcpiNsCheckPredefinedNames(ACPI_NAMESPACE_NODE *Node,
...
void AcpiNsCheckParameterCount(char *Pathname,
...
ACPI_STATUS
AcpiNsBuildExternalPath(ACPI_NAMESPACE_NODE *Node, ACPI_SIZE Size, char *NameBuffer);
...
ACPI_STATUS
AcpiNsHandleToPathname(ACPI_HANDLE TargetHandle, ACPI_BUFFER *Buffer);

BOOLEAN
AcpiNsPatternMatch(ACPI_NAMESPACE_NODE *ObjNode, char *SearchFor);

ACPI_STATUS
AcpiNsGetNode(ACPI_NAMESPACE_NODE *PrefixNode,
 ...
 */
ACPI_STATUS
AcpiNsAttachObject(ACPI_NAMESPACE_NODE *Node,
...
ACPI_STATUS
AcpiNsGetAttachedData(ACPI_NAMESPACE_NODE *Node,
 ...
 */
ACPI_STATUS
AcpiNsRepairObject(ACPI_PREDEFINED_DATA *Data,
...
ACPI_STATUS
AcpiNsRepairNullElement(ACPI_PREDEFINED_DATA *Data,
						UINT32 ExpectedBtypes,
						UINT32 PackageIndex,
						ACPI_OPERAND_OBJECT **ReturnObjectPtr);

void AcpiNsRemoveNullElements(ACPI_PREDEFINED_DATA *Data,
							  UINT8 PackageType,
 ...
 */
ACPI_STATUS
AcpiNsComplexRepairs(ACPI_PREDEFINED_DATA *Data,
					 ACPI_NAMESPACE_NODE *Node,
 ...
 */
ACPI_STATUS
AcpiNsSearchAndEnter(UINT32 EntryName,
					 ACPI_WALK_STATE *WalkState,
					 ACPI_NAMESPACE_NODE *Node,
					 ACPI_INTERPRETER_MODE InterpreterMode,
					 ACPI_OBJECT_TYPE Type,
...
ACPI_STATUS
AcpiNsSearchOneScope(UINT32 EntryName,
					 ACPI_NAMESPACE_NODE *Node,
					 ACPI_OBJECT_TYPE Type,
					 ACPI_NAMESPACE_NODE **RetNode);
 ...
 */
BOOLEAN
AcpiNsValidRootPrefix(char Prefix);
...
ACPI_STATUS
AcpiNsExternalizeName(UINT32 InternalNameLength,
