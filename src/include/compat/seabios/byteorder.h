...
#include <compat/seabios/types.h>  // u32
...
#define swab32(x) (__builtin_constant_p((u32)(x)) ? __swab32_constant(x) : __swab32(x))
#define swab64(x) (__builtin_constant_p((u64)(x)) ? __swab64_constant(x) : __swab64(x))
