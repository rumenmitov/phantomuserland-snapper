...
static __inline unsigned int read_eflags(void)
{
	unsigned int ef;
...
static __inline void write_eflags(unsigned int ef)
{
...
static __inline unsigned int get_esp(void)
{
	unsigned int sel;
...
static __inline unsigned int get_ss(void)
{
	unsigned int sel;
...
static __inline u_int64_t rdmsr(unsigned int msr)
{
	u_int64_t rv;
...
static __inline void wrmsr(unsigned int msr, u_int64_t newval)
{
	__asm __volatile("wrmsr" : : "A"(newval), "c"(msr));
}


static __inline u_int16_t rdldt(void)
{
	u_int16_t ldtr;
...
static __inline void wrldt(u_int16_t sel)
{
...
static __inline void ia32_pause(void)
{
 ...
 */
static __inline void invltlb(void)
{
 ...
 */
static __inline void invlpg(unsigned int addr)
{
...
static __inline unsigned int rdr6(void)
{
	unsigned int data;
...
static __inline void load_dr6(unsigned int dr6)
{
...
#define set_ldt(seg) asm volatile("lldt %0" : : "rm"((unsigned short)(seg)))
...
#define clear_ts() asm volatile("clts")
...
#define set_tr(seg) asm volatile("ltr %0" : : "rm"((unsigned short)(seg)))
