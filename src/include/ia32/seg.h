...
void fill_gate(struct real_gate *gate,
			   unsigned offset,
...
#define get_descriptor(array, sel) \
	((struct real_descriptor *)(((char *)array) + (sel & SEL_MASK)))
