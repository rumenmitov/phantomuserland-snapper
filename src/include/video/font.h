...
void w_font_draw_string(window_handle_t win,
...
// void 	drv_video_font_scroll_pixels( drv_video_window_t *win, int npix, rgba_t
// color);

// returns new x position
void w_font_tty_string(drv_video_window_t *win,
