...
typedef void (*button_callback_t)(window_handle_t w,
								  pool_handle_t button_handle,
								  void *arg);
...
pool_handle_t w_add_button(window_handle_t w,
						   int id,
						   int x,
						   int y,
						   drv_video_bitmap_t *bmp,
...
void w_button_set_text(window_handle_t w,
					   pool_handle_t bh,
					   const char *text,
					   color_t text_color);
...
void w_button_set_callback(window_handle_t w,
						   pool_handle_t button_handle,
