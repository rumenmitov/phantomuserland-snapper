...
#define _C_COLOR_TRANSPARENT \
	{                        \
		0, 0, 0, 0           \
	}

#define _C_COLOR_BLACK \
	{                  \
		0, 0, 0, 0xFF  \
	}
#define _C_COLOR_WHITE         \
	{                          \
		0xFF, 0xFF, 0xFF, 0xFF \
	}
...
#define _C_COLOR_LIGHTRED      \
	{                          \
		0x40, 0x40, 0xFF, 0xFF \
	}

#define _C_COLOR_GREEN   \
	{                    \
		0, 0x80, 0, 0xFF \
	}
#define _C_COLOR_LIGHTGREEN    \
	{                          \
		0x40, 0xFF, 0x40, 0xFF \
	}

#define _C_COLOR_BLUE    \
	{                    \
		0x80, 0, 0, 0xFF \
	}
#define _C_COLOR_LIGHTBLUE     \
	{                          \
		0xFF, 0x40, 0x40, 0xFF \
	}

#define _C_COLOR_DARKGRAY      \
	{                          \
		0x40, 0x40, 0x40, 0xFF \
	}
#define _C_COLOR_LIGHTGRAY     \
	{                          \
		0x80, 0x80, 0x80, 0xFF \
	}

#define _C_COLOR_YELLOW        \
	{                          \
		0x00, 0xFF, 0xFF, 0xFF \
	}

#define _C_COLOR_MAGENTA       \
	{                          \
		0xFF, 0x00, 0xFF, 0xFF \
	}
#define _C_COLOR_CYAN          \
	{                          \
		0xFF, 0xFF, 0x00, 0xFF \
	}
