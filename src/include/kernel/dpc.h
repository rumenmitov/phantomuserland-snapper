...
static __inline__ void dpc_request_move_to_beginning(dpc_request *me)
{
	...
	if (dpc_request_first)
		dpc_request_first->prev = me;
...
static __inline__ void dpc_request_init(dpc_request *me, void (*_func)(void *))
{
	me->go = 0;
	me->func = _func;
	me->arg = 0;
...
static __inline__ void dpc_request_trigger(dpc_request *me, void *_arg)
{
	if ((dpc_stop_request) || (!dpc_init_ok))
		dpc_panic();
	...
	if ((me->arg || _arg) && me->go)
		panic("double dpc trigger with arg");
