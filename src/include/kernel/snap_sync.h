...
extern volatile int
	phantom_virtual_machine_stop_request;  // Is one (with the
										   // phantom_virtual_machine_snap_request) when
										   // threads are asked to do harakiri
