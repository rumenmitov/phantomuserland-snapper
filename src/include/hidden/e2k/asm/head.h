...
#define E2K_KERNEL_PAGE_SIZE \
	(cpu_has(CPU_HWBUG_LARGE_PAGES) ? E2K_SMALL_PAGE_SIZE : E2K_LARGE_PAGE_SIZE)
#define BOOT_E2K_KERNEL_PAGE_SIZE \
	(boot_cpu_has(CPU_HWBUG_LARGE_PAGES) ? E2K_SMALL_PAGE_SIZE : BOOT_E2K_LARGE_PAGE_SIZE)
...
#define E2K_LEGACY_SIC_CPU_STARTUP_ADDR    E2K_LEGACY_SIC_BIOS_AREA_PHYS_BASE
...
#define E2K_MODULE_START                                                        \
	_PAGE_ALIGN_DOWN((E2K_KERNEL_IMAGE_AREA_BASE + E2K_KERNEL_IMAGE_AREA_SIZE), \
 ...
 */
#define E2K_KERNEL_NAMETAB_AREA_BASE  (E2K_KERNEL_IMAGE_AREA_BASE + E2K_KERNEL_AREAS_SIZE)
...
#define E2K_WAIT_OP_ALL_C_MASK 0x01 /* wait for all previous operatons */
									/* complete */
#define E2K_WAIT_OP_ALL_MASK                                                 \
	(E2K_WAIT_OP_MA_C_MASK | E2K_WAIT_OP_FL_C_MASK | E2K_WAIT_OP_LD_C_MASK | \
	 E2K_WAIT_OP_ST_C_MASK | E2K_WAIT_OP_ALL_C_MASK | E2K_WAIT_OP_ALL_E_MASK)
