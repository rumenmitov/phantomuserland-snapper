...
#define MAS_VA_PROBE                                  \
	((MAS_MODE_STORE_MMU_AAU_SPEC << MAS_MOD_SHIFT) | \
	 ((MAS_OPC_TLB_ADDR_PROBE << MAS_OPC_SHIFT) & MAS_OPC_MASK))

/* DTLB entry probe  */
#define MAS_ENTRY_PROBE                               \
	((MAS_MODE_STORE_MMU_AAU_SPEC << MAS_MOD_SHIFT) | \
	 ((MAS_OPC_TLB_ENTRY_PROBE << MAS_OPC_SHIFT) & MAS_OPC_MASK))
...
#define MAS_MLT_STORE_LOCK     (_MAS_MODE_LOAD_OP_TRAP_ON_STORE << MAS_MOD_SHIFT)
...
#define MAS_MLT_REG                                                         \
	((MAS_MODE_STORE_MMU_AAU_SPEC << MAS_MOD_SHIFT) |                       \
	 (((MAS_OPC_MMU_REG | MAS_OPC_ICACHE_FLUSH | MAS_OPC_DCACHE_LINE_FLUSH) \
	   << MAS_OPC_SHIFT) &                                                  \
	  MAS_OPC_MASK))

/* DAM  table */
#define MAS_DAM_REG                          \
	((_MAS_MODE_DAM_LOAD << MAS_MOD_SHIFT) | \
	 (((MAS_OPC_DAM_REG) << MAS_OPC_SHIFT) & MAS_OPC_MASK))
