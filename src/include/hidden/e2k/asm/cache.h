...
#define L1_CACHE_SHIFT_MAX                                                         \
	_max_(_max_(_max_(_max_(_max_(_max_(E8C2_L1_CACHE_SHIFT, E1CP_L1_CACHE_SHIFT), \
								  E8C_L1_CACHE_SHIFT),                             \
							E2S_L1_CACHE_SHIFT),                                   \
					  ES2_L1_CACHE_SHIFT),                                         \
				E3S_L1_CACHE_SHIFT),                                               \
...
#define L2_CACHE_SHIFT_MAX                                                         \
	_max_(_max_(_max_(_max_(_max_(_max_(E8C2_L2_CACHE_SHIFT, E1CP_L2_CACHE_SHIFT), \
								  E8C_L2_CACHE_SHIFT),                             \
							E2S_L2_CACHE_SHIFT),                                   \
					  ES2_L2_CACHE_SHIFT),                                         \
				E3S_L2_CACHE_SHIFT),                                               \
