...
#define CONFIG0_MIPS4K5K ((K_CacheAttrCN << S_ConfigK23) | (K_CacheAttrCN << S_ConfigKU))

/* MIPS 24K specifics */
#define STATUS_MIPS24K 0
#define CONFIG0_MIPS24K \
	((K_CacheAttrCN << S_ConfigK23) | (K_CacheAttrCN << S_ConfigKU) | (M_ConfigMM))

/* MIPS 34K specifics */
#define STATUS_MIPS34K 0
#define CONFIG0_MIPS34K \
	((K_CacheAttrCN << S_ConfigK23) | (K_CacheAttrCN << S_ConfigKU) | (M_ConfigMM))

/* MIPS 74K specifics */
#define STATUS_MIPS74K 0
#define CONFIG0_MIPS74K \
	((K_CacheAttrCN << S_ConfigK23) | (K_CacheAttrCN << S_ConfigKU) | (M_ConfigMM))

/* MIPS 1074K specifics */
#define STATUS_MIPS1074K 0
#define CONFIG0_MIPS1074K \
	((K_CacheAttrCN << S_ConfigK23) | (K_CacheAttrCN << S_ConfigKU) | (M_ConfigMM))

/* MIPS 1004K specifics */
#define STATUS_MIPS1004K 0
#define CONFIG0_MIPS1004K \
	((K_CacheAttrCN << S_ConfigK23) | (K_CacheAttrCN << S_ConfigKU) | (M_ConfigMM))
...
/* QED specifics  */
#define STATUS_QED                                                                 \
	((C0_STATUS_QED_KSU_KERNEL << C0_STATUS_QED_KSU_SHF) | C0_STATUS_QED_BEV_BIT | \
	 C0_STATUS_QED_FR_BIT)

#define CONFIG_QED                                                           \
	((C0_CONFIG_QED_EC_X3 << C0_CONFIG_QED_EC_SHF) |                         \
	 (C0_CONFIG_QED_EP_DDDD << C0_CONFIG_QED_EP_SHF) |                       \
	 (C0_CONFIG_QED_EW_64 << C0_CONFIG_QED_EW_SHF) | C0_CONFIG_QED_SCN_BIT | \
	 C0_CONFIG_QED_EM_BIT | (C0_CONFIG_QED_EB_SUB << C0_CONFIG_QED_EB_SHF) | \
 ...
 *
 ************************************************************************/
void arch_platform_init(bool early); /* TRUE -> Before initmodules(), FALSE -> after */
 ...
 *
 ************************************************************************/
void arch_core_init(bool early,     /* TRUE -> Before initmodules(), FALSE -> after */
