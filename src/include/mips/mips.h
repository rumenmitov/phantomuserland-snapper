...
#define MIPS_4Kc ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_Jade << S_PRIdImp))

#define MIPS_4Kmp ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_JadeLite << S_PRIdImp))

#define MIPS_4KEc ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_4KEc << S_PRIdImp))

#define MIPS_4KEc_R2 ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_4KEc_R2 << S_PRIdImp))

#define MIPS_4KEmp ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_4KEmp << S_PRIdImp))

#define MIPS_4KEmp_R2 \
	((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_4KEmp_R2 << S_PRIdImp))

#define MIPS_4KSc ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_4KSc << S_PRIdImp))

#define MIPS_4KSd ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_4KSd << S_PRIdImp))

#define MIPS_5K ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_Opal << S_PRIdImp))

#define MIPS_20Kc ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_Ruby << S_PRIdImp))

#define MIPS_M4K ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_M4K << S_PRIdImp))

#define MIPS_M14K ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_M14K << S_PRIdImp))

#define MIPS_M14Kc ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_M14Kc << S_PRIdImp))

#define MIPS_25Kf ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_Amethyst << S_PRIdImp))

#define MIPS_5KE ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_5KE << S_PRIdImp))

#define MIPS_24K ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_24K << S_PRIdImp))

#define MIPS_24KE ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_24KE << S_PRIdImp))

#define MIPS_34K ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_34K << S_PRIdImp))

#define MIPS_74K ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_74K << S_PRIdImp))

#define MIPS_1074K ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_1074K << S_PRIdImp))

#define MIPS_1004K ((K_PRIdCoID_MIPS << S_PRIdCoID) | (K_PRIdImp_1004K << S_PRIdImp))

#define QED_RM52XX \
	((C0_PRID_COMP_NOT_MIPS32_64 << S_PRIdCoID) | (K_PRIdImp_R5200 << S_PRIdImp))

#define QED_RM70XX \
	((C0_PRID_COMP_NOT_MIPS32_64 << S_PRIdCoID) | (C0_PRID_PRID_RM70XX << S_PRIdImp))
...
#define MFC0(dst, src) mfc0 dst, src

#define DMFC0(dst, src) dmfc0 dst, src
...
#define LDC1(dst, src, offs) .##word(0xd4000000 | ((src) << 21) | ((dst) << 16) | (offs))

#define SDC1(src, dst, offs) .##word(0xf4000000 | ((dst) << 21) | ((src) << 16) | (offs))

/* Release 2 */
#define RDPGPR(rd, rt) .##word(0x41400000 | ((rd) << 11) | (rt << 16))

#define WRPGPR(rd, rt) .##word(0x41c00000 | ((rd) << 11) | (rt << 16))


/* MT ASE */
#define DVPE(rt) .##word(0x41600001 | ((rt) << 16))

#define DMT(rt) .##word(0x41600bc1 | ((rt) << 16))

#define EVPE(rt) .##word(0x41600021 | ((rt) << 16))

#define EMT(rt) .##word(0x41600be1 | ((rt) << 16))
