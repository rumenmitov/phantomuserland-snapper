...
// type MESSAGE_ADDR_TYPE is a continuous area of data defined by a starting address (see
// ARINC 653 Part 1);
...
// ENTRY_KIND_TYPE *ENTRY_KIND, RETURN_CODE_TYPE *RETURN_CODE_TYPE, FILE_ERRNO_TYPE *ERRNO
// );
