...
struct cpfs_stat
{
	...
	// cpfs_time_t         vtime; // version of file forked (not used, will mark time when
	// this backup version of file is forked from main version)
...
typedef dir_scan_ret_t (*dir_scan_func_t)(struct cpfs_fs *fs,
										  struct cpfs_dir_entry *de,
										  void *farg);
