...
extern void rgba2rgba_zbmove(
	struct rgba_t *dest, const struct rgba_t *src, zbuf_t *zb, int nelem, zbuf_t zpos);
extern void mmx_rgba2rgba_zbmove(
	struct rgba_t *dest, const struct rgba_t *src, zbuf_t *zb, int nelem, zbuf_t zpos);
extern void sse_rgba2rgba_zbmove(
	struct rgba_t *dest, const struct rgba_t *src, zbuf_t *zb, int nelem, zbuf_t zpos);
extern void sseu_rgba2rgba_zbmove(
	struct rgba_t *dest, const struct rgba_t *src, zbuf_t *zb, int nelem, zbuf_t zpos);
extern void auto_rgba2rgba_zbmove(
	struct rgba_t *dest, const struct rgba_t *src, zbuf_t *zb, int nelem, zbuf_t zpos);
