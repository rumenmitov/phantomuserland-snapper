 ...
 */
extern int vm_hashmap_iterate(map_t in, PFany f, any_t item);
 ...
 */
extern int vm_hashmap_get_one(map_t in, any_t *arg, int remove);

/*
 * Free the hashmap
 */
extern void vm_hashmap_free(map_t in);
