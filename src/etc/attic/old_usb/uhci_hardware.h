...
typedef struct
{
	...
	// Software part
	physaddr_t	this_phy;		// A physical pointer to this address
...
{
	// Hardware part
	u_int32_t	link_phy;		// Link to the next TD/QH
	u_int32_t	status;			// Status field
	u_int32_t	token;			// Contains the packet header (where it needs to be sent)
	u_int32_t	buffer_phy;		// A pointer to the buffer with the actual packet
	// Software part
	physaddr_t	this_phy;		// A physical pointer to this address
	void		*link_log;		// Pointer to the next logical TD/QT
	void		*buffer_log;	// Pointer to the logical buffer
...
typedef struct
{
	...
	// Software part
	physaddr_t	this_phy;		// The physical pointer to this address
