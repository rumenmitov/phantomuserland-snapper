...
static isa_probe_t board_drivers[] = {
	...
	/*
		...
		{ "MMC",		driver_pl181_mmc_probe,   	1, 0x1C000000, 23 }, // And 24 - how
	   do we give 2 irqs? { "PL050.kb",      	driver_pl050_keyb_probe,   	1, 0x18000000,
	   3 }, { "PL050.ms",      	driver_pl050_mouse_probe,   	1, 0x19000000, 4 },
	*/
