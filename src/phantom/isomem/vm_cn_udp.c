...
errno_t cn_udp_do_operation(int op_no,
...
static pvm_object_t cn_udp_blocking_syscall_worker(pvm_object_t conn,
...
// Init connection
errno_t cn_udp_init(struct data_area_4_connection *c,
					struct data_area_4_thread *t,
					const char *suffix)
{
	(void)t;
