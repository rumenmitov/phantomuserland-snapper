...
//     // TODO alloc_region steps by map_elem size, it takes 32 pages to fullfill request
//     of 1 page!
...
//     phantom_phys_alloc_init( &low_map, 0x100000/PAGE_SIZE ); // All the possible low
//     mem low_map.n_used_pages = 0; //low_map.allocable_size = 0x100000/PAGE_SIZE;
...
// void
// hal_free_phys_page(physaddr_t  paddr) // alloc and not map - WILL PANIC if page is
// mapped!
// {
...
// size_t pahantom_free_phys_mem_kb() { return PG2KB( pm_map.allocable_size -
// pm_map.n_used_pages ); }
