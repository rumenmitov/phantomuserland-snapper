...
static __inline__ int paging_device_can_grow(paging_device *me)
{
	(void)me;
	return 0;
}  // can I grow pagespace

// static __inline__ void
// paging_device_io_completion_interrupt(paging_device *me) { dpc_request_trigger(
// &me->io_done_dpc, me); }

static __inline__ int paging_device_pages_available(paging_device *me)
{
	return me->n_pages;
}  // size in pages
...
// void                paging_device_start_read (paging_device *me, disk_page_no_t disk,
// phys_page_t mem, void *vmem, void (*callback)() ); void
// paging_device_start_write(paging_device *me, disk_page_no_t disk, phys_page_t mem, void
// *vmem, void (*callback)() );
void paging_device_start_read(paging_device *me,
							  disk_page_no_t disk,
							  physaddr_t mem,
							  void (*callback)());
void paging_device_start_write(paging_device *me,
							   disk_page_no_t disk,
							   physaddr_t mem,
							   void (*callback)());

void paging_device_start_read_rq(paging_device *me,
								 pager_io_request *,
								 void (*callback)());
void paging_device_start_write_rq(paging_device *me,
								  pager_io_request *,
								  void (*callback)());
