...
static void framebuffer_bitblt_part(
	const rgba_t *, int, int, int, int, int, int, int, int, zbuf_t, u_int32_t);
...
static char *framebuffer_screen(void)
{
	return ph_framebuffer_get_screen();
}
...
static void framebuffer_bitblt(const rgba_t *from,
							   int xpos,
							   int ypos,
							   int xsize,
							   int ysize,
...
static void framebuffer_bitblt_part(const rgba_t *from,
									int src_xsize,
									int src_ysize,
									int src_xpos,
									int src_ypos,
