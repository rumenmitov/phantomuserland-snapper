...
void bitmap2bitmap(struct rgba_t *dest,
				   int destWidth,
				   int destHeight,
				   int destX,
				   int destY,
...
void w_draw_bitmap(drv_video_window_t *w, int x, int y, drv_video_bitmap_t *bmp)
{
