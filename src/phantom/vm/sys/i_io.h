...
struct data_area_4_io
{
	...
	u_int32_t                           out_count;      // num of objects put and not
processed by kernel
	...
	u_int32_t                           in_sleep_count;  // n of threads sleeping for
input u_int32_t                           out_sleep_count; // n of threads sleeping for
output
...
#error mutex?
	...
	u_int32_t                           reset;          // not operational, unblock
waiting threads
};
