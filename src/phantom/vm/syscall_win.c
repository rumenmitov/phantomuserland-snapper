...
static int si_window_5_tostring(pvm_object_t o,
								pvm_object_t *ret,
...
static int win_getXSize(pvm_object_t o,
						pvm_object_t *ret,
						struct data_area_4_thread *tc,
						int n_args,
						pvm_object_t *args)
...
static int win_getYSize(pvm_object_t o,
						pvm_object_t *ret,
						struct data_area_4_thread *tc,
						int n_args,
						pvm_object_t *args)
...
static int win_getX(pvm_object_t o,
					pvm_object_t *ret,
					struct data_area_4_thread *tc,
					int n_args,
					pvm_object_t *args)
...
static int win_getY(pvm_object_t o,
					pvm_object_t *ret,
					struct data_area_4_thread *tc,
					int n_args,
					pvm_object_t *args)
...
static int win_clear_20(pvm_object_t me,
						pvm_object_t *ret,
						struct data_area_4_thread *tc,
						int n_args,
						pvm_object_t *args)
...
static int win_fill_21(pvm_object_t me,
					   pvm_object_t *ret,
					   struct data_area_4_thread *tc,
					   int n_args,
					   pvm_object_t *args)
...
static int win_setFGcolor_22(pvm_object_t me,
							 pvm_object_t *ret,
							 struct data_area_4_thread *tc,
							 int n_args,
							 pvm_object_t *args)
...
static int win_setBGcolor_23(pvm_object_t me,
							 pvm_object_t *ret,
							 struct data_area_4_thread *tc,
							 int n_args,
							 pvm_object_t *args)
...
static int win_putString_24(pvm_object_t me,
							pvm_object_t *ret,
							struct data_area_4_thread *tc,
							int n_args,
							pvm_object_t *args)
...
#define BS 1024
	...
	// TODO make a version of drv_video_font_tty_string that accepts non-zero terminated
	// strings with len
...
static int win_putImage_25(pvm_object_t me,
						   pvm_object_t *ret,
						   struct data_area_4_thread *tc,
						   int n_args,
						   pvm_object_t *args)
...
static int win_setSize_26(pvm_object_t me,
						  pvm_object_t *ret,
						  struct data_area_4_thread *tc,
						  int n_args,
						  pvm_object_t *args)
...
static int win_setPos_27(pvm_object_t me,
						 pvm_object_t *ret,
						 struct data_area_4_thread *tc,
						 int n_args,
						 pvm_object_t *args)
...
static int win_drawLine_28(pvm_object_t me,
						   pvm_object_t *ret,
						   struct data_area_4_thread *tc,
						   int n_args,
						   pvm_object_t *args)
...
static int win_drawBox_29(pvm_object_t me,
						  pvm_object_t *ret,
						  struct data_area_4_thread *tc,
						  int n_args,
						  pvm_object_t *args)
...
static int win_fillBox_30(pvm_object_t me,
						  pvm_object_t *ret,
						  struct data_area_4_thread *tc,
						  int n_args,
						  pvm_object_t *args)
...
static int win_fillEllipse_31(pvm_object_t me,
							  pvm_object_t *ret,
							  struct data_area_4_thread *tc,
							  int n_args,
							  pvm_object_t *args)
...
static int win_setHandler_32(pvm_object_t me,
							 pvm_object_t *ret,
							 struct data_area_4_thread *tc,
							 int n_args,
							 pvm_object_t *args)
...
static int win_setTitle_33(pvm_object_t me,
						   pvm_object_t *ret,
						   struct data_area_4_thread *tc,
						   int n_args,
						   pvm_object_t *args)
{
	...
	if (len > PVM_MAX_TTY_TITLE - 1)
		len = PVM_MAX_TTY_TITLE - 1;
...
static int win_update_34(pvm_object_t me,
						 pvm_object_t *ret,
						 struct data_area_4_thread *tc,
						 int n_args,
						 pvm_object_t *args)
...
static int win_scrollHor_35(pvm_object_t me,
							pvm_object_t *ret,
							struct data_area_4_thread *tc,
							int n_args,
							pvm_object_t *args)
...
static int win_drawImagePart_36(pvm_object_t me,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
static int win_setAutoUpdate_37(pvm_object_t me,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
syscall_func_t syscall_table_4_window[32 + 8] = {
	...
	&win_update_34,
	&win_scrollHor_35,
	&win_drawImagePart_36,
	&win_setAutoUpdate_37,
	&invalid_syscall,
	&invalid_syscall,
