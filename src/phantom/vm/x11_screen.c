	...
	case WM_MOUSEMOVE:
		{
			...
			int yPos = VSCREEN_HEIGHT - (short)(0x0FFFF &
(lParam>>16));//GET_Y_LPARAM(lParam);
...
void win_x11_key_event(
	int x, int y, unsigned int state, unsigned int keycode, int isRelease)
{
