 ...
 *
 * This source file implements heasdless (no graphics) wrapper for VM to run in Unox or
...
int pvm_video_init()
{
	...
	drv_video_headless.screen = (void*)screen_image;
...
void win_x11_key_event( int x, int y, unsigned int state, unsigned int keycode, int
isRelease )
{
