...
int invalid_syscall(pvm_object_t o,
					pvm_object_t *ret,
...
{
	DEBUG_INFO;
	ph_printf("invalid syscal for object: ");
	dumpo((addr_t)(o));
...
int si_void_0_construct(pvm_object_t o,
						pvm_object_t *ret,
						struct data_area_4_thread *tc,
						int n_args,
						pvm_object_t *args)
...
int si_void_1_destruct(pvm_object_t o,
					   pvm_object_t *ret,
					   struct data_area_4_thread *tc,
					   int n_args,
					   pvm_object_t *args)
...
int si_void_2_class(pvm_object_t this_obj,
					pvm_object_t *ret,
					struct data_area_4_thread *tc,
					int n_args,
					pvm_object_t *args)
...
int si_void_3_clone(pvm_object_t o,
					pvm_object_t *ret,
					struct data_area_4_thread *tc,
					int n_args,
					pvm_object_t *args)
...
int si_void_4_equals(pvm_object_t me,
					 pvm_object_t *ret,
					 struct data_area_4_thread *tc,
					 int n_args,
					 pvm_object_t *args)
...
int si_void_5_tostring(pvm_object_t o,
					   pvm_object_t *ret,
					   struct data_area_4_thread *tc,
					   int n_args,
					   pvm_object_t *args)
...
int si_void_6_toXML(pvm_object_t o,
					pvm_object_t *ret,
					struct data_area_4_thread *tc,
					int n_args,
					pvm_object_t *args)
...
int si_void_7_fromXML(pvm_object_t o,
					  pvm_object_t *ret,
					  struct data_area_4_thread *tc,
					  int n_args,
					  pvm_object_t *args)
...
int si_void_14_to_immutable(pvm_object_t o,
							pvm_object_t *ret,
							struct data_area_4_thread *tc,
							int n_args,
							pvm_object_t *args)
...
int si_void_15_hashcode(pvm_object_t me,
						pvm_object_t *ret,
						struct data_area_4_thread *tc,
						int n_args,
						pvm_object_t *args)
...
syscall_func_t syscall_table_4_void[16] = {&si_void_0_construct,
										   &si_void_1_destruct,
										   &si_void_2_class,
										   &si_void_3_clone,
										   &si_void_4_equals,
...
static int si_int_3_clone(pvm_object_t me,
						  pvm_object_t *ret,
						  struct data_area_4_thread *tc,
						  int n_args,
						  pvm_object_t *args)
...
static int si_int_4_equals(pvm_object_t me,
						   pvm_object_t *ret,
						   struct data_area_4_thread *tc,
						   int n_args,
						   pvm_object_t *args)
...
static int si_int_5_tostring(pvm_object_t me,
							 pvm_object_t *ret,
							 struct data_area_4_thread *tc,
							 int n_args,
							 pvm_object_t *args)
...
static int si_int_6_toXML(pvm_object_t me,
						  pvm_object_t *ret,
						  struct data_area_4_thread *tc,
						  int n_args,
						  pvm_object_t *args)
...
syscall_func_t syscall_table_4_int[16] = {&si_void_0_construct,
										  &si_void_1_destruct,
										  &si_void_2_class,
										  &si_int_3_clone,
										  &si_int_4_equals,
...
static int si_long_3_clone(pvm_object_t me,
						   pvm_object_t *ret,
						   struct data_area_4_thread *tc,
						   int n_args,
						   pvm_object_t *args)
...
static int si_long_4_equals(pvm_object_t me,
							pvm_object_t *ret,
							struct data_area_4_thread *tc,
							int n_args,
							pvm_object_t *args)
...
static int si_long_5_tostring(pvm_object_t me,
							  pvm_object_t *ret,
							  struct data_area_4_thread *tc,
							  int n_args,
							  pvm_object_t *args)
...
static int si_long_6_toXML(pvm_object_t me,
						   pvm_object_t *ret,
						   struct data_area_4_thread *tc,
						   int n_args,
						   pvm_object_t *args)
...
syscall_func_t syscall_table_4_long[16] = {&si_void_0_construct,
										   &si_void_1_destruct,
										   &si_void_2_class,
										   &si_long_3_clone,
										   &si_long_4_equals,
...
static int si_float_3_clone(pvm_object_t me,
							pvm_object_t *ret,
							struct data_area_4_thread *tc,
							int n_args,
							pvm_object_t *args)
...
static int si_float_4_equals(pvm_object_t me,
							 pvm_object_t *ret,
							 struct data_area_4_thread *tc,
							 int n_args,
							 pvm_object_t *args)
...
static int si_float_5_tostring(pvm_object_t me,
							   pvm_object_t *ret,
							   struct data_area_4_thread *tc,
							   int n_args,
							   pvm_object_t *args)
...
static int si_float_6_toXML(pvm_object_t me,
							pvm_object_t *ret,
							struct data_area_4_thread *tc,
							int n_args,
							pvm_object_t *args)
...
syscall_func_t syscall_table_4_float[16] = {&si_void_0_construct,
											&si_void_1_destruct,
											&si_void_2_class,
											&si_float_3_clone,
											&si_float_4_equals,
...
static int si_double_3_clone(pvm_object_t me,
							 pvm_object_t *ret,
							 struct data_area_4_thread *tc,
							 int n_args,
							 pvm_object_t *args)
...
static int si_double_4_equals(pvm_object_t me,
							  pvm_object_t *ret,
							  struct data_area_4_thread *tc,
							  int n_args,
							  pvm_object_t *args)
...
static int si_double_5_tostring(pvm_object_t me,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
static int si_double_6_toXML(pvm_object_t me,
							 pvm_object_t *ret,
							 struct data_area_4_thread *tc,
							 int n_args,
							 pvm_object_t *args)
...
syscall_func_t syscall_table_4_double[16] = {&si_void_0_construct,
											 &si_void_1_destruct,
											 &si_void_2_class,
											 &si_double_3_clone,
											 &si_double_4_equals,
											 &si_double_5_tostring,
											 &si_double_6_toXML,
											 &si_void_7_fromXML,
											 // 8
											 &invalid_syscall,
...
static int si_string_3_clone(pvm_object_t me,
							 pvm_object_t *ret,
							 struct data_area_4_thread *tc,
							 int n_args,
							 pvm_object_t *args)
...
static int si_string_4_equals(pvm_object_t me,
							  pvm_object_t *ret,
							  struct data_area_4_thread *tc,
							  int n_args,
							  pvm_object_t *args)
{
	...
	if (!pvm_is_null(him)) {
		...
		iret = me->_class == him->_class && meda->length == himda->length &&
			   0 == ph_strncmp((const char *)meda->data,
							   (const char *)himda->data,
							   meda->length);
	}
	SYS_FREE_O(him);
...
static int si_string_5_tostring(pvm_object_t me,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
static int si_string_8_substring(pvm_object_t me,
								 pvm_object_t *ret,
								 struct data_area_4_thread *tc,
								 int n_args,
								 pvm_object_t *args)
...
static int si_string_9_charat(pvm_object_t me,
							  pvm_object_t *ret,
							  struct data_area_4_thread *tc,
							  int n_args,
							  pvm_object_t *args)
...
static int si_string_10_concat(pvm_object_t me,
							   pvm_object_t *ret,
							   struct data_area_4_thread *tc,
							   int n_args,
							   pvm_object_t *args)
{
	...
	pvm_object_t oret = pvm_create_string_object_binary_cat(
		(char *)meda->data, meda->length, (char *)himda->data, himda->length);
...
static int si_string_11_length(pvm_object_t me,
							   pvm_object_t *ret,
							   struct data_area_4_thread *tc,
							   int n_args,
							   pvm_object_t *args)
...
static int si_string_12_find(pvm_object_t me,
							 pvm_object_t *ret,
							 struct data_area_4_thread *tc,
							 int n_args,
							 pvm_object_t *args)
...
static int si_string_16_toint(pvm_object_t me,
							  pvm_object_t *ret,
							  struct data_area_4_thread *tc,
							  int n_args,
							  pvm_object_t *args)
...
static int si_string_17_tolong(pvm_object_t me,
							   pvm_object_t *ret,
							   struct data_area_4_thread *tc,
							   int n_args,
							   pvm_object_t *args)
...
static int si_string_18_tofloat(pvm_object_t me,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
static int si_string_19_todouble(pvm_object_t me,
								 pvm_object_t *ret,
								 struct data_area_4_thread *tc,
								 int n_args,
								 pvm_object_t *args)
...
static int si_string_20_parse_json(pvm_object_t me,
								   pvm_object_t *ret,
								   struct data_area_4_thread *tc,
								   int n_args,
								   pvm_object_t *args)
...
syscall_func_t syscall_table_4_string[21] = {&si_void_0_construct,
											 &si_void_1_destruct,
											 &si_void_2_class,
											 &si_string_3_clone,
											 &si_string_4_equals,
											 &si_string_5_tostring,
											 &si_void_6_toXML,
											 &si_void_7_fromXML,
											 // 8
											 ...
											 &si_string_16_toint,
											 &si_string_17_tolong,
											 &si_string_18_tofloat,
											 &si_string_19_todouble,
...
static int si_thread_5_tostring(pvm_object_t me,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
/*
static int si_thread_8_start( pvm_object_t me, pvm_object_t *ret, struct
data_area_4_thread *tc, int n_args, pvm_object_t *args )
{
	(void)me;
	DEBUG_INFO;
...
static int si_thread_10_pause(pvm_object_t me,
							  pvm_object_t *ret,
							  struct data_area_4_thread *tc,
							  int n_args,
							  pvm_object_t *args)
...
static int si_thread_11_continue(pvm_object_t me,
								 pvm_object_t *ret,
								 struct data_area_4_thread *tc,
								 int n_args,
								 pvm_object_t *args)
...
static int si_thread_14_getOsInterface(pvm_object_t me,
									   pvm_object_t *ret,
									   struct data_area_4_thread *tc,
									   int n_args,
									   pvm_object_t *args)
...
static int si_thread_13_getUser(pvm_object_t me,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
static int si_thread_12_getEnvironment(pvm_object_t me,
									   pvm_object_t *ret,
									   struct data_area_4_thread *tc,
									   int n_args,
									   pvm_object_t *args)
...
syscall_func_t syscall_table_4_thread[16] = {&si_void_0_construct,
											 &si_void_1_destruct,
											 &si_void_2_class,
											 &si_void_3_clone,
											 &si_void_4_equals,
											 &si_thread_5_tostring,
											 &si_void_6_toXML,
											 &si_void_7_fromXML,
											 // 8
											 &invalid_syscall,
											 &invalid_syscall,
											 &si_thread_10_pause,
											 &si_thread_11_continue,
											 &si_thread_12_getEnvironment,
											 &si_thread_13_getUser,
											 &si_thread_14_getOsInterface,
											 &si_void_15_hashcode};
...
static int si_call_frame_5_tostring(pvm_object_t me,
									pvm_object_t *ret,
									struct data_area_4_thread *tc,
									int n_args,
									pvm_object_t *args)
...
syscall_func_t syscall_table_4_call_frame[16] = {&si_void_0_construct,
												 &si_void_1_destruct,
												 &si_void_2_class,
												 &si_void_3_clone,
												 &si_void_4_equals,
												 &si_call_frame_5_tostring,
												 &si_void_6_toXML,
												 &si_void_7_fromXML,
												 // 8
												 &invalid_syscall,
...
static int si_istack_5_tostring(pvm_object_t me,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
syscall_func_t syscall_table_4_istack[16] = {&si_void_0_construct,
											 &si_void_1_destruct,
											 &si_void_2_class,
											 &si_void_3_clone,
											 &si_void_4_equals,
											 &si_istack_5_tostring,
											 &si_void_6_toXML,
											 &si_void_7_fromXML,
											 // 8
											 &invalid_syscall,
...
static int si_ostack_5_tostring(pvm_object_t me,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
syscall_func_t syscall_table_4_ostack[16] = {&si_void_0_construct,
											 &si_void_1_destruct,
											 &si_void_2_class,
											 &si_void_3_clone,
											 &si_void_4_equals,
											 &si_ostack_5_tostring,
											 &si_void_6_toXML,
											 &si_void_7_fromXML,
											 // 8
											 &invalid_syscall,
...
static int si_estack_5_tostring(pvm_object_t me,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
syscall_func_t syscall_table_4_estack[16] = {&si_void_0_construct,
											 &si_void_1_destruct,
											 &si_void_2_class,
											 &si_void_3_clone,
											 &si_void_4_equals,
											 &si_estack_5_tostring,
											 &si_void_6_toXML,
											 &si_void_7_fromXML,
											 // 8
											 &invalid_syscall,
...
static int si_class_class_5_tostring(pvm_object_t me,
									 pvm_object_t *ret,
									 struct data_area_4_thread *tc,
									 int n_args,
									 pvm_object_t *args)
...
// TODO who needs this?
static int si_class_class_8_new_class(pvm_object_t me,
									  pvm_object_t *ret,
									  struct data_area_4_thread *tc,
									  int n_args,
									  pvm_object_t *args)
...
static int si_class_10_set_static(pvm_object_t me,
								  pvm_object_t *ret,
								  struct data_area_4_thread *tc,
								  int n_args,
								  pvm_object_t *args)
...
static int si_class_11_get_static(pvm_object_t me,
								  pvm_object_t *ret,
								  struct data_area_4_thread *tc,
								  int n_args,
								  pvm_object_t *args)
...
static int si_class_14_instanceof(pvm_object_t me,
								  pvm_object_t *ret,
								  struct data_area_4_thread *tc,
								  int n_args,
								  pvm_object_t *args)
...
syscall_func_t syscall_table_4_class[16] = {&si_void_0_construct,
											&si_void_1_destruct,
											&si_void_2_class,
											&si_void_3_clone,
											&si_void_4_equals,
											&si_class_class_5_tostring,
											&si_void_6_toXML,
											&si_void_7_fromXML,
											// 8
											&si_class_class_8_new_class,
											&invalid_syscall,
											&si_class_10_set_static,
											&si_class_11_get_static,
											&invalid_syscall,
											&invalid_syscall,
											&si_class_14_instanceof,
											&si_void_15_hashcode};
...
static int si_interface_5_tostring(pvm_object_t me,
								   pvm_object_t *ret,
								   struct data_area_4_thread *tc,
								   int n_args,
								   pvm_object_t *args)
...
syscall_func_t syscall_table_4_interface[16] = {&si_void_0_construct,
												&si_void_1_destruct,
												&si_void_2_class,
												&si_void_3_clone,
												&si_void_4_equals,
												&si_interface_5_tostring,
												&si_void_6_toXML,
												&si_void_7_fromXML,
												// 8
												&invalid_syscall,
...
static int si_code_5_tostring(pvm_object_t me,
							  pvm_object_t *ret,
							  struct data_area_4_thread *tc,
							  int n_args,
							  pvm_object_t *args)
...
syscall_func_t syscall_table_4_code[16] = {&si_void_0_construct,
										   &si_void_1_destruct,
										   &si_void_2_class,
										   &si_void_3_clone,
										   &si_void_4_equals,
...
static int si_page_5_tostring(pvm_object_t me,
							  pvm_object_t *ret,
							  struct data_area_4_thread *tc,
							  int n_args,
							  pvm_object_t *args)
...
syscall_func_t syscall_table_4_page[16] = {&si_void_0_construct,
										   &si_void_1_destruct,
										   &si_void_2_class,
										   &si_void_3_clone,
										   &si_void_4_equals,
...
errno_t pvm_class_cache_lookup(const char *name, int name_len, pvm_object_t *new_class)
{
	...
	return ENOENT;
#else
	if (DEBUG_CACHED_CLASSES)
		ph_printf("---- pvm_class_cache_lookup %.*s\n", name_len, name);
...
#else
	if (DEBUG_CACHED_CLASSES)
		ph_printf("---- pvm_class_cache_insert %.*s\n", name_len, name);
	struct data_area_4_directory *da = pvm_object_da(pvm_root.class_dir, directory);
...
static int si_bootstrap_5_tostring(pvm_object_t me,
								   pvm_object_t *ret,
								   struct data_area_4_thread *tc,
								   int n_args,
								   pvm_object_t *args)
...
static int si_bootstrap_8_load_class(pvm_object_t me,
									 pvm_object_t *ret,
									 struct data_area_4_thread *tc,
									 int n_args,
									 pvm_object_t *args)
...
static int si_bootstrap_16_print(pvm_object_t me,
								 pvm_object_t *ret,
								 struct data_area_4_thread *tc,
								 int n_args,
								 pvm_object_t *args)
...
static int si_bootstrap_17_register_class_loader(pvm_object_t me,
												 pvm_object_t *ret,
												 struct data_area_4_thread *tc,
												 int n_args,
												 pvm_object_t *args)
...
static int si_bootstrap_18_thread(pvm_object_t me,
								  pvm_object_t *ret,
								  struct data_area_4_thread *tc,
								  int n_args,
								  pvm_object_t *args)
{
	...
	// TODO check object class to be runnable or subclass
	{
		...
		pvm_istack_push(pvm_object_da(cfda->istack, integer_stack),
						1);  // pass him real number of parameters
...
static int si_bootstrap_19_create_binary(pvm_object_t me,
										 pvm_object_t *ret,
										 struct data_area_4_thread *tc,
										 int n_args,
										 pvm_object_t *args)
...
static int si_bootstrap_20_set_screen_background(pvm_object_t me,
												 pvm_object_t *ret,
												 struct data_area_4_thread *tc,
												 int n_args,
												 pvm_object_t *args)
{
...
#if !VIDEO_NEW_BG_WIN
	if (back_win == 0)
		back_win = drv_video_window_create(scr_get_xsize(),
										   scr_get_ysize(),
										   0,
										   0,
										   COLOR_BLACK,
	...
	bitmap2bitmap(back_win->w_pixel,
				  back_win->xsize,
				  back_win->ysize,
				  0,
				  0,
...
static int si_bootstrap_21_sleep(pvm_object_t me,
								 pvm_object_t *ret,
								 struct data_area_4_thread *tc,
								 int n_args,
								 pvm_object_t *args)
...
static int si_bootstrap_22_set_os_interface(pvm_object_t me,
											pvm_object_t *ret,
											struct data_area_4_thread *tc,
											int n_args,
											pvm_object_t *args)
...
static int si_bootstrap_23_getenv(pvm_object_t me,
								  pvm_object_t *ret,
								  struct data_area_4_thread *tc,
								  int n_args,
								  pvm_object_t *args)
...
static int si_bootstrap_24_reboot(pvm_object_t me,
								  pvm_object_t *ret,
								  struct data_area_4_thread *tc,
								  int n_args,
								  pvm_object_t *args)
...
syscall_func_t syscall_table_4_boot[25] = {&si_void_0_construct,
										   &si_void_1_destruct,
										   &si_void_2_class,
										   &si_void_3_clone,
										   &si_void_4_equals,
										   &si_bootstrap_5_tostring,
										   &si_void_6_toXML,
										   &si_void_7_fromXML,
										   // 8
										   &si_bootstrap_8_load_class,
										   &invalid_syscall,  //&si_bootstrap_9_load_code,
										   &invalid_syscall,
										   &invalid_syscall,
										   &invalid_syscall,
										   &invalid_syscall,
										   ...
										   &si_void_15_hashcode,
										   // 16
										   &si_bootstrap_16_print,
										   &si_bootstrap_17_register_class_loader,
										   &si_bootstrap_18_thread,
										   &si_bootstrap_19_create_binary,
										   &si_bootstrap_20_set_screen_background,
										   &si_bootstrap_21_sleep,
										   &si_bootstrap_22_set_os_interface,
										   &si_bootstrap_23_getenv,
										   // 24
...
static int si_array_5_tostring(pvm_object_t me,
							   pvm_object_t *ret,
							   struct data_area_4_thread *tc,
							   int n_args,
							   pvm_object_t *args)
...
static int si_array_8_get_iterator(pvm_object_t me,
								   pvm_object_t *ret,
								   struct data_area_4_thread *tc,
								   int n_args,
								   pvm_object_t *args)
...
static int si_array_9_get_subarray(pvm_object_t me,
								   pvm_object_t *ret,
								   struct data_area_4_thread *tc,
								   int n_args,
								   pvm_object_t *args)
...
static int si_array_10_get(pvm_object_t me,
						   pvm_object_t *ret,
						   struct data_area_4_thread *tc,
						   int n_args,
						   pvm_object_t *args)
...
static int si_array_11_set(pvm_object_t me,
						   pvm_object_t *ret,
						   struct data_area_4_thread *tc,
						   int n_args,
						   pvm_object_t *args)
...
static int si_array_12_size(pvm_object_t me,
							pvm_object_t *ret,
							struct data_area_4_thread *tc,
							int n_args,
							pvm_object_t *args)
...
syscall_func_t syscall_table_4_array[16] = {
	...
	&si_void_7_fromXML,
	// 8
	&si_array_8_get_iterator,
	&si_array_9_get_subarray,
	&si_array_10_get,
	&si_array_11_set,
	&si_array_12_size,
	&invalid_syscall,
...
static int si_binary_5_tostring(pvm_object_t o,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
static int si_binary_8_getbyte(pvm_object_t me,
							   pvm_object_t *ret,
							   struct data_area_4_thread *tc,
							   int n_args,
							   pvm_object_t *args)
...
static int si_binary_9_setbyte(pvm_object_t me,
							   pvm_object_t *ret,
							   struct data_area_4_thread *tc,
							   int n_args,
							   pvm_object_t *args)
...
static int si_binary_10_setrange(pvm_object_t me,
								 pvm_object_t *ret,
								 struct data_area_4_thread *tc,
								 int n_args,
								 pvm_object_t *args)
...
syscall_func_t syscall_table_4_binary[16] = {
	...
	&si_void_3_clone,
	&si_void_4_equals,
	&si_binary_5_tostring,
	&si_void_6_toXML,
	&si_void_7_fromXML,
	// 8
	&si_binary_8_getbyte,
	&si_binary_9_setbyte,
	&si_binary_10_setrange,
	&invalid_syscall,
	&invalid_syscall,
	&invalid_syscall,
	&invalid_syscall,
...
static int si_closure_9_getordinal(pvm_object_t me,
								   pvm_object_t *ret,
								   struct data_area_4_thread *tc,
								   int n_args,
								   pvm_object_t *args)
...
static int si_closure_10_setordinal(pvm_object_t me,
									pvm_object_t *ret,
									struct data_area_4_thread *tc,
									int n_args,
									pvm_object_t *args)
...
static int si_closure_11_setobject(pvm_object_t me,
								   pvm_object_t *ret,
								   struct data_area_4_thread *tc,
								   int n_args,
								   pvm_object_t *args)
...
syscall_func_t syscall_table_4_closure[16] = {
	...
	// 8
	&invalid_syscall,
	&si_closure_9_getordinal,
	&si_closure_10_setordinal,
	&si_closure_11_setobject,
	&invalid_syscall,
	&invalid_syscall,
	&invalid_syscall,
	&si_void_15_hashcode
...
static int si_bitmap_5_tostring(pvm_object_t o,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
static int si_bitmap_8_fromstring(pvm_object_t me,
								  pvm_object_t *ret,
								  struct data_area_4_thread *tc,
								  int n_args,
								  pvm_object_t *args)
...
static int si_bitmap_9_paintto(pvm_object_t me,
							   pvm_object_t *ret,
							   struct data_area_4_thread *tc,
							   int n_args,
							   pvm_object_t *args)
...
syscall_func_t syscall_table_4_bitmap[16] = {
	...
	&si_void_3_clone,
	&si_void_4_equals,
	&si_bitmap_5_tostring,
	&si_void_6_toXML,
	&si_void_7_fromXML,
	// 8
	&si_bitmap_8_fromstring,
	&si_bitmap_9_paintto,
	&invalid_syscall,
	&invalid_syscall,
	&invalid_syscall,
...
static int si_world_5_tostring(pvm_object_t o,
							   pvm_object_t *ret,
							   struct data_area_4_thread *tc,
							   int n_args,
							   pvm_object_t *args)
...
static int si_world_8_getMyThread(pvm_object_t o,
								  pvm_object_t *ret,
								  struct data_area_4_thread *tc,
								  int n_args,
								  pvm_object_t *args)
{
	(void)o;
	DEBUG_INFO;
	pvm_object_t out = (pvm_object_storage_t *)(tc - DA_OFFSET());  // TODO XXX HACK!
...
static int si_weakref_5_tostring(pvm_object_t o,
								 pvm_object_t *ret,
								 struct data_area_4_thread *tc,
								 int n_args,
								 pvm_object_t *args)
...
static int si_weakref_8_getMyObject(pvm_object_t o,
									pvm_object_t *ret,
									struct data_area_4_thread *tc,
									int n_args,
									pvm_object_t *args)
...
syscall_func_t syscall_table_4_weakref[16] = {
	...
	&si_void_3_clone,
	&si_void_4_equals,
	&si_weakref_5_tostring,
	&si_void_6_toXML,
	&si_void_7_fromXML,
	// 8
	&si_weakref_8_getMyObject,
	&invalid_syscall,
	&invalid_syscall,
	&invalid_syscall,
	&invalid_syscall,
...
static int si_directory_4_equals(pvm_object_t o,
								 pvm_object_t *ret,
								 struct data_area_4_thread *tc,
								 int n_args,
								 pvm_object_t *args)
...
static int si_directory_5_tostring(pvm_object_t o,
								   pvm_object_t *ret,
								   struct data_area_4_thread *tc,
								   int n_args,
								   pvm_object_t *args)
...
static int si_directory_8_put(pvm_object_t o,
							  pvm_object_t *ret,
							  struct data_area_4_thread *tc,
							  int n_args,
							  pvm_object_t *args)
{
	...
	if (rc)
		SYS_FREE_O(val);  // we didn't put it there

	SYSCALL_RETURN(pvm_create_int_object(rc));
}

static int si_directory_9_get(pvm_object_t o,
							  pvm_object_t *ret,
							  struct data_area_4_thread *tc,
							  int n_args,
							  pvm_object_t *args)
...
static int si_directory_10_remove(pvm_object_t o,
								  pvm_object_t *ret,
								  struct data_area_4_thread *tc,
								  int n_args,
								  pvm_object_t *args)
...
static int si_directory_11_size(pvm_object_t o,
								pvm_object_t *ret,
								struct data_area_4_thread *tc,
								int n_args,
								pvm_object_t *args)
...
// Returns iterator
static int si_directory_12_iterate(pvm_object_t o,
								   pvm_object_t *ret,
								   struct data_area_4_thread *tc,
								   int n_args,
								   pvm_object_t *args)
...
syscall_func_t syscall_table_4_directory[16] = {
	...
	&si_void_2_class,
	&si_void_3_clone,
	&si_directory_4_equals,
	&si_directory_5_tostring,
	&si_void_6_toXML,
	&si_void_7_fromXML,
	// 8
	&si_directory_8_put,
	&si_directory_9_get,
	&si_directory_10_remove,
	&si_directory_11_size,
	&si_directory_12_iterate,
	&invalid_syscall,
	&invalid_syscall,
	&si_void_15_hashcode,
...
static int si_connection_5_tostring(pvm_object_t o,
									pvm_object_t *ret,
									struct data_area_4_thread *tc,
									int n_args,
									pvm_object_t *args)
...
static int si_connection_8_connect(pvm_object_t o,
								   pvm_object_t *ret,
								   struct data_area_4_thread *tc,
								   int n_args,
								   pvm_object_t *args)
...
static int si_connection_9_disconnect(pvm_object_t o,
									  pvm_object_t *ret,
									  struct data_area_4_thread *tc,
									  int n_args,
									  pvm_object_t *args)
...
// Not needed at all?
static int si_connection_10_check(pvm_object_t o,
								  pvm_object_t *ret,
								  struct data_area_4_thread *tc,
								  int n_args,
								  pvm_object_t *args)
...
// Not needed at all?
static int si_connection_11_do(pvm_object_t o,
							   pvm_object_t *ret,
							   struct data_area_4_thread *tc,
							   int n_args,
							   pvm_object_t *args)
...
static int si_connection_12_set_callback(pvm_object_t o,
										 pvm_object_t *ret,
										 struct data_area_4_thread *tc,
										 int n_args,
										 pvm_object_t *args)
...
static int si_connection_13_blocking(pvm_object_t o,
									 pvm_object_t *ret,
									 struct data_area_4_thread *tc,
									 int n_args,
									 pvm_object_t *args)
{
	...
	pvm_object_t (*syscall_worker)(pvm_object_t,
								   struct data_area_4_thread *,
								   int nmethod,
								   pvm_object_t arg) = da->blocking_syscall_worker;
...
syscall_func_t syscall_table_4_connection[16] = {
	...
	&si_void_3_clone,
	&si_void_4_equals,
	&si_connection_5_tostring,
	&si_void_6_toXML,
	&si_void_7_fromXML,
	// 8
	&si_connection_8_connect,
	&si_connection_9_disconnect,
	&si_connection_10_check,
	&si_connection_11_do,
	&si_connection_12_set_callback,
	&si_connection_13_blocking,
	&invalid_syscall,
	&si_void_15_hashcode,
