...
void hashmap_put(Hashmap *h, void *key, void *key_end, void *data, void *data_end)
{
...
void *hashmap_get_or_put(Hashmap *h, void *key, void *key_end, void *data, void *data_end)
{
...
void *hashmap_iterate(Hashmap *h, iter *i, void **value)
{
	...
	if (s->entry)
		s->entry = s->entry->next_in_bucket;
...
void resize_up(Hashmap *h_old)
{
	Hashmap h;
	int i;
	if (table_size[h_old->table_size_index + 1] == 0)
		return;
